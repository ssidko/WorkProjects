...
public:
	...
	void Print(DWORD x, DWORD y, const TCHAR *str, WORD text_colour);
	void Print(DWORD x, DWORD y, const TCHAR *str, WORD text_colour, WORD background_colour);

	void Printf(const TCHAR *format, ...);
	void Printf(WORD text_colour, const TCHAR *format, ...);

	void SetTextColour(WORD text_colour);
	void SetBackgroundColour(WORD background_colour);
	void SetColour(WORD text_colour, WORD background_colour);

	void SetPosition(DWORD x, DWORD y);

	WinConsole & operator<<(const TCHAR *str);
