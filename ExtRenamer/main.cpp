...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//{
		...
		//CHAR *str = "¨¦++ ++ ++-+¦L 9_üãL++T+T_240205.xls";

		//TCHAR w_buff[1024] = {0};
		//BYTE a_buff[1024] = {0};

		//MultiByteToWideChar(20866, 0, str, strlen(str), w_buff, 1024);



		ForEachFileFolder(_T("F:\\August"), ChangeCpInFileFolderName, ChangeCpInFileFolderName, TRUE);
	//}
