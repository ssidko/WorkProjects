	...
	WinApiException() : error_code(::GetLastError())
	{
		if (error_code) {
			...
			if (::FormatMessageA(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM, NULL, error_code, 0, (LPSTR)&str, 0, NULL)) {
				...
				error_description = "Ќе удалось получить описание ошибки.";
			}
		}
	}
...
int main(int argc, char *argv[])
{
	...
	//DbFile db("d:\\Work\\чиста€ база\\1Cv8.1CD", PageSize::size_4kb);
	//if (db.Open()) {
	//
	//	std::vector<uint8_t> buff;

	//	std::shared_ptr<Object> obj = db.GetObject(5);
	//	obj->SaveToFile("d:\\Work\\чиста€ база\\object_5.bin");

	//	//obj = db.GetObject(12);
	//	//obj->SaveToFile("d:\\Work\\чиста€ база\\object_12.bin");

	//	//obj = db.GetObject(13);
	//	//obj->SaveToFile("d:\\Work\\чиста€ база\\object_13.bin");

	//	//obj = db.GetObject(16);
	//	//obj->SaveToFile("d:\\Work\\чиста€ база\\object_16.bin");
	//
	//}
