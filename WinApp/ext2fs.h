...
#define EXT2_SUPERBLOCK_OFFSET		(WORD)1024
...
//
// Structure of a blocks group descriptor for ext2 & ext3
// Дескриптор группы блоков, одинаков для ext2 и ext3
//
...
public:
	Ext2Volume(TCHAR *file_name, LONGLONG offset = 0);
	~Ext2Volume();
